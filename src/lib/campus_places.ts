...
export const CAMPUS_PLACES: CampusPlace[] = [
    ...
    { id: "iese", name: "IESE", category: "Schools", lat: 33.64771, lng: 72.98977, blurb: "Environmental Sciences and Engineering, part of SCEE." },
    ...
    { id: "retro", name: "Retro Cafe", category: "Cafes", lat: 33.6396, lng: 72.98793, blurb: "In the boys' hostel area, open until 11pm, delivers to hostels free." },
    ...
    { id: "old-gym", name: "Old Gym", category: "Sports", lat: 33.6451, lng: 72.99316, blurb: "By the girls' hostels, and free to use." },
    ...
    { id: "hbl-football", name: "HBL Football Ground", category: "Sports", lat: 33.64521, lng: 72.98372, blurb: "Full-size football ground." },
    ...
    { id: "tennis", name: "Tennis Court", category: "Sports", lat: 33.64238, lng: 72.99651, blurb: "Proper tennis courts on the eastern side." },
