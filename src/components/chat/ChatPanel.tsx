                        ...
                        <div className="flex flex-wrap gap-2">
                            {EXAMPLES.map((example) => (
                                <button
                                    key={example}
                                    onClick={() => ask(example)}
                                    className="border-2 border-nust-blue rounded-full px-3 py-1 text-xs bg-white text-nust-blue hover:bg-nust-orange hover:text-white transition-colors cursor-pointer"
                                >
                                    {example}
                                </button>
                            ))}
